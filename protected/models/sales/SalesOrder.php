...
class SalesOrder extends EActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('is_unsystem_pay, date_closed, date_created, date_updated, date_deleted', 'safe'),
    ...
    public function checkBookingExists() {
        ...
        if (strIsEmpty($bkRefNo) === false) {
            ...
            if (isset($booking) && $this->bk_type == StatCode::TRANS_TYPE_AB) {
    ...
    public function getOptionsPayChannel() {
        return array(
            self::PAY_CHANNEL_EBANK => '网银转账',
