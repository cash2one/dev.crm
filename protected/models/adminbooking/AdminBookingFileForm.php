...
class AdminBookingFileForm extends EFormModel {
    ...
    public function rules() {
        ...
        return array(
            array('uid, admin_booking_id, file_name, file_url, file_ext, file_size, has_remote, remote_domain,remote_file_key, report_type', 'required'),
