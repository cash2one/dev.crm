...
class BookingFileForm extends EFormModel {
    ...
    public function rules() {
        ...
        return array(
            array('uid, booking_id, file_name, file_url, file_ext, file_size, has_remote, remote_domain,remote_file_key, report_type', 'required'),
            array('booking_id, file_size, user_id, has_remote', 'numerical', 'integerOnly' => true),
            ...
            array('user_id, mime_type, file_size', 'safe'),
        );
    }
