...
class AdminBookingForm extends EFormModel {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('ref_no, patient_name, expected_hospital_name, expected_hp_dept_name, expected_doctor_name, final_doctor_name, order_amount, total_amount', 'length', 'max' => 20),
            ...
            array('cs_explain', 'length', 'max' => 500),
    ...
    public function loadOptionBookingService() {
        if (is_null($this->option_booking_service_id)) {
            $this->option_booking_service_id = AdminBooking::model()->getOptionsBookingService();
        }
