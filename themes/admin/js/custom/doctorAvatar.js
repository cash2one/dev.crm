    ...
    var uploader = Qiniu.uploader({
        ...
        init: {
            ...
            'FileUploaded': function (up, file, info) {
                ...
                formdata.append('doctor[id]', domForm.find('#doctorId').val());
                formdata.append('doctor[remote_domain]', domForm.find('#domain').val());
                formdata.append('doctor[remote_file_key]', infoJson.key);
                $.ajax({
